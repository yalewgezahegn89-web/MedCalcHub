...
export const apgarScoreCalculator: CalculatorDefinition = {
  ...
  clinicalNotes:
    "The Apgar score is a rapid, standardized assessment of newborn condition introduced by Virginia Apgar in 1953. It evaluates five signs — Appearance (skin color), Pulse (heart rate), Grimace (reflex irritability), Activity (muscle tone), and Respiration (breathing effort) — each scored 0, 1, or 2 for a total of 0–10.\n\nScoring is performed at 1 minute and 5 minutes after birth. If the 5-minute score is below 7, continue scoring every 5 minutes up to 20 minutes. The 1-minute score reflects the need for immediate intervention; the 5-minute score assesses the response to resuscitation and the adequacy of the transition to extrauterine life.\n\nA score of 7–10 is considered reassuring and indicates a newborn who is transitioning well. A score of 4–6 indicates moderate depression and may require stimulation, warmth, airway positioning, and close reassessment. A score of 0–3 indicates severe depression and the need for immediate, active resuscitation.\n\nCritical limitations: The AAP and ACOG (2015) emphasize that the Apgar score should be reported but should not be used alone to drive resuscitation decisions — respirations, heart rate, and color guide resuscitation. Low scores may occur in preterm infants, infants whose mothers received sedation, or those with congenital anomalies, without implying birth asphyxia. The score has inter-observer variability and is a snapshot of clinical status, not a diagnostic test. It should not be used to predict long-term neurologic outcomes.",
