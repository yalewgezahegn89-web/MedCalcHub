...
export default function ResultCard({
  ...
  return (
    <section aria-label="Calculation result" className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-lg dark:border-slate-800 dark:bg-slate-900">
