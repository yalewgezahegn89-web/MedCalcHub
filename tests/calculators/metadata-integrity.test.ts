...
describe("Calculator Metadata Repository Integrity", () => {
  ...
  it("registry integrity remains intact (116 unique calculators)", () => {
    expect(registered).toHaveLength(116);
  ...
  it("all 116 registered calculators remain resolvable by id and slug", () => {
